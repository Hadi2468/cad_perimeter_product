# CAD Perimeter Product Problem
In this problem, a list of line segments is given, and each segment has the coordination of its start and end points as: [((x1, y1), (x2, y2)), …]. I want to calculate the multiplicative product of
